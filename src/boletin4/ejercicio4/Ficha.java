...
public abstract class Ficha implements Comparable<Ficha>{
	...
	/**
	 * Funcion que compara y devuelve la posicion de la ficha segun su identificador
	 * en orden ascendente
	 * 
	 * @return Devuelve la posicion de la ficha segun su identificador en orden ascendente
	 */
	@Override
